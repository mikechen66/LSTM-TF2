...
if __name__ == '__main__':
    ...
    for ticker in tickers:
        ...
        aapl_momentum.plotBuySellPoints(model=None, return_threshold=None, days_topredict=None, filename='momentum_buysell.png')
        aapl_momentum.plotPortfolioReturn(model=None, return_threshold=None, days_topredict=None, filename='momentum_return.png')